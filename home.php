...
<<<<<<< HEAD
	...
	<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
		...
		<div class="container mt-5">
			<div class="row h-45">
				<div class="col-md-6 my-auto">
					<h1 class="landing-title">Be inspired. Stay Confident</h1>
		...
		<div class="container">
			<div class="card-deck">
				...
				<div class="card home-box-shadow">
					...
					<div class="card-body txtcardpic">
		...
		<div class="full-width-image mt-5">
			<div class="container img-fluid" style="height: 771px;background-image: url(<?php echo get_template_directory_uri(); ?>/images/overban.png);">
				<img style="margin-top: 77px;" src="<?php echo get_template_directory_uri(); ?>/images/mainpicban.png" alt="">
			</div>
		...
		<div class="container outcomemarg">
			<div class="row">
				...
				<div class="col-md-9">
					<div class="card-deck">
						<div class="card land-card">
							<div class="col-md-3" style="margin-top: 40px; margin-left: 32px;">
...
>>>>>>> 3878bc2198521b5eb996ff0179006b89b4188ab6
