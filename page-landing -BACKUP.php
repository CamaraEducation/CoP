...
$Pathway_name = get_term( $current_user_pathway, 'pathway' )->name;
...
<p class="txt-pos" align="left"><h4><?php  echo $communityRole_name . ' @ ' . $org_name; ?> </h4></p>
<span class="badge badge-success float-left mr-2" style="background-color: #3ECCCB;">
    <?php echo $Pathway_name; ?></span> 
<span class="badge badge-light float-left" style="background-color: #B4B4B4; opacity: 0.5; color: #1d1d1d;"><?php echo $memberJobRole_name; ?></span>
</div>
