...
/**
                  ...
                  */
                                                      ?>
                                                      <p class="meet-company-text" ><a href="<?php echo home_url()?>/directory/?fcrl=<?php echo $term->term_id;?>" style="text-transform:capitalize;font-family: Lato; font-style: normal; font-weight: bold; font-size: 24px; line-height: 16px; color: #B0B7BF;"><?php 
                                                      $num = count($copusers);
                                                      if ($num < 10){
                                                      echo "0";
                                                      echo $num;
                                                      ...
                                                      ?></a>
                                                      	...
                                                      	<span class="communityrole">
                                                      		<a style="float: center;" href="<?php echo home_url()?>/directory/?fcrl=<?php echo $term->term_id;?>"><?php echo $term->name;?></a> <span class="float-right"> >  
                                                      		</span>
                                                      		<?php
                                                      	}
                                                      	?>
