...
<div class="text-center">
	<span style="margin:14px;display:block;"> Did you forgot your username/password?  <a href="<?php echo get_site_url();?>/resetpassword">Click here </a>to reset it or <a href="<?php echo get_site_url();?>/register"> create </a> a new account. </span>
